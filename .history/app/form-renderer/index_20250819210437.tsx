...
        const whatsAppSettings = field.settings as any;
...
      }
      case 'custom-image': {
        const imageSettings = field.settings as any;
        const alignStyle = {
          display: 'flex',
...
    const configText = configElement.textContent;
    console.log('📄 Raw config text:', configText); // Add this debug line
...
    const mainConfig: Config = JSON.parse(configText);
    console.log('📋 Parsed config:', mainConfig); // Add this debug line
