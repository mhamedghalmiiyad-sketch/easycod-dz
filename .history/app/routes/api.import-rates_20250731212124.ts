...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  const apiUrl = url.searchParams.get("apiUrl"); // Note: This is received but not used in the logic below.
  ...
  try {
    ...
    if (apiProvider === 'noest') {
      ...
      // Safely access nested properties and provide a fallback empty object
