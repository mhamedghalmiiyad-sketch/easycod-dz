...
// Note: The processing logic will produce a flexible object that can be
// handled by the final formatting step.
interface DeliveryRate {
  wilaya_id: number;
  wilaya_name_fr: string;
  wilaya_name_ar: string;
  home_fee?: number; // Made optional to accommodate 'tarif'
  desk_fee?: number; // Made optional to accommodate 'tarif_stopdesk'
  tarif?: number;
