              ...
              <Box maxWidth="600px" width="100%">
                <div style={{
                  ...
                  <div style={{
                    ...
                    width: '200%',
                    height: '200%',
                    background: 'radial-gradient(circle, rgba(0, 166, 82, 0.05) 0%, transparent 70%)',
            ...
            <InlineStack align="space-between" blockAlign="center">
              <InlineStack gap="400" blockAlign="center">
                <div style={{
                  ...
                  position: 'relative',
                  overflow: 'hidden',
                  animation: step.completed ? 'pulse 2s infinite' : isNext ? 'pulse 2s infinite' : 'none'
                }}>
                  {step.completed ? (
              ...
              <div style={{
                ...
                background: step.completed 
                  ...
                  : isNext 
                    ? 'rgba(0, 102, 204, 0.1)'
                    : 'rgba(0, 0, 0, 0.05)',
                border: `2px solid ${step.completed ? '#00A652' : isNext ? '#0066CC' : '#e1e1e1'}`,
                transition: 'all 0.3s ease'
              }}>
                <Text 
                  as="p" 
                  variant="bodyMd" 
                  fontWeight="semibold"
                  tone={step.completed ? "success" : isNext ? "info" : "subdued"}
                >
