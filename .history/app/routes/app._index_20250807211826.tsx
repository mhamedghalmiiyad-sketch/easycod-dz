  ...
  return (
    <div
      style={{
        ...
        filter: isHovered ? 'drop-shadow(0 4px 20px rgba(0, 166, 82, 0.1))' : 'none'
      }}
                ...
                <Box padding="400">
                  ...
                  >
                    <InlineStack align="space-between" blockAlign="center">
                      ...
                      <Icon source={openStep === guideStep.id ? ChevronDownIcon : ChevronRightIcon} />
                    </InlineStack>
                  </div>
                  
                  <Collapsible
                    open={openStep === guideStep.id}
