...
export default function DashboardPage() {
  ...
  const generateEmbedDeepLink = () => {
    ...
    const API_KEY = "your-app-api-key"; // Get this from your app.toml file
    const EMBED_HANDLE = "your-embed-block-handle"; // The filename of your embed block (without .liquid)
