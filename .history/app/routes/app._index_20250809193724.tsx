...
// ❌ Leaky server-only imports were here and are now moved into the loader.
...
export default function DashboardPage() {
  ...
  const generateEmbedDeepLink = () => {
    // This handle MUST match the filename in extensions/easycod-embed/blocks/
    const EMBED_HANDLE = "easycod-form";
  ...
  // NEW: Function to open the preview link
  const handlePreviewClick = () => {
    // Note: The subpath 'codform' should match your shopify.app.toml [app_proxy] setting
    const previewUrl = `https://${shopDomain}/apps/codform?preview=true&shop=${shopDomain}`;
  ...
  return (
    <Page
      fullWidth
      title="Dashboard"
      // NEW: Added primaryAction for the preview button
      primaryAction={{
        content: "Preview Form on Store",
