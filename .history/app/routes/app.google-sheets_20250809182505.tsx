...
// ✅ FIXED: Move Google API imports to server-only functions
...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  try {
    const { google, OAuth2Client } = await getGoogleSheetsApi();
  ...
  return (
    <Frame>
      ...
      <Page
        ...
        subtitle="Automatically sync your COD orders to Google Sheets"
        backAction={{
          content: "Back",
          onAction: () => {
...
function GoogleLoginView() {
  ...
  return (
    <Page title="Google Sheets Integration">
      <Layout>
        <Layout.Section variant="oneHalf">
          <Card>
            <BlockStack gap="500">
