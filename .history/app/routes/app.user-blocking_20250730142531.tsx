...
import {
  ...
  ChevronDownIcon,
  ChevronUpIcon,
  FraudProtectIcon, // Added for the new section
  ...
  return (
    <Frame>
      ...
      <Page
        ...
        titleMetadata={
          <Badge tone={activeRulesCount > 0 ? "success" : "attention"}>
            {activeRulesCount === 0
              ? "No active rules"
              ...
              <BlockStack gap="600">
                ...
                <Card>
                  <BlockStack gap="400">
                    <InlineStack align="space-between" blockAlign="center">
                      <InlineStack gap="200" blockAlign="center">
                        <Icon source={RiskIcon} tone="base" />
                    ...
                    <Collapsible id="risk-scoring-section" open={expandedSections.riskScoring}>
                      <BlockStack gap="400">
                        ...
                        <Checkbox
                          label="Enable automated risk scoring"
