...
// Augment the JSX types to include the <ui-save-bar> with its `show` attribute.
// This teaches TypeScript what props this custom element accepts.
declare global {
  namespace JSX {
...
export default function VisibilityPage() {
  ...
  return (
    <Frame>
      {/* Declaratively show the save bar based on the hasUnsavedChanges state */}
      <ui-save-bar show={hasUnsavedChanges}>
        {/*
          'data-save-button' and 'data-discard-button' are used by the web component
          to identify the action buttons.
        */}
        <button
          data-save-button
          type="button"
