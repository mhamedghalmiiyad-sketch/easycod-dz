...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  try {
    ...
    // Use the utility function to save settings - store as individual fields
    await upsertShopSettings(session.shop, {
      visibilityMode: visibilitySettings.visibilityMode,
      visibleProducts: visibilitySettings.visibleProducts,
      hiddenProducts: visibilitySettings.hiddenProducts,
      allowedCountries: visibilitySettings.allowedCountries,
      hideAddToCart: visibilitySettings.hideAddToCart,
      hideBuyNow: visibilitySettings.hideBuyNow,
      disableOnHome: visibilitySettings.disableOnHome,
      disableOnCollections: visibilitySettings.disableOnCollections,
      enableSpecificProducts: visibilitySettings.enableSpecificProducts,
      disableSpecificProducts: visibilitySettings.disableSpecificProducts,
      enableSpecificCountries: visibilitySettings.enableSpecificCountries,
      minimumAmount: visibilitySettings.minimumAmount,
      maximumAmount: visibilitySettings.maximumAmount,
    });
