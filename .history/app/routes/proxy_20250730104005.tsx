...
// NEW: User Blocking Settings Definition
...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  try {
    ...
    // END: NEW - Save data for future time-based checks
