  ...
  const proxyHtml = `
    ...
    <html>
      ...
      <body>
        ...
        <script>
          // FormApp component code should be inlined here
          // Note: External script /form-renderer.js is not included as it won't work in app proxy
          console.log('FormApp component should be inlined here');
        </script>
      </body>
    </html>
  `;
