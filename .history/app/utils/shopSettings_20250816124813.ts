...
// FIX: Import specific Prisma types needed for function arguments and variables.
import {
  Prisma,
...
export async function initializeShopSettings(shopId: string) {
  try {
    ...
    if (!existing) {
      ...
      // FIX: Use the directly imported 'ShopSettingsUpdateInput' type.
...
export async function upsertShopSettings(
  ...
  // FIX: Use the directly imported 'ShopSettingsCreateInput' type.
...
export async function updateAppProxySettings(
  ...
  // FIX: Use the directly imported 'AppProxyUpdateInput' type.
