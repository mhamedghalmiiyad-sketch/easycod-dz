...
export default defineConfig({
  ...
  plugins: [
    remix({
      ...
      // Removed browserNodeBuiltinsPolyfill and serverNodeBuiltinsPolyfill
    }),
    tsconfigPaths(),
    nodePolyfills({
      // Define Node.js built-in modules to polyfill for browser
      include: [
        "http",
        "https",
        "zlib",
  ...
  ssr: {
    ...
    ], // Changed from false to array of modules
  },
  optimizeDeps: {
    exclude: [
      "google-auth-library",
