...
// Remove the shopifyApp import from here - it's not needed in Vite config
// The shopifyApp function is used in your server-side code (app/shopify.server.ts)
...
export default defineConfig({
  plugins: [
    ...
    // Remove the shopifyApp plugin - it's not a Vite plugin
    tsconfigPaths(),
  ],
  build: {
