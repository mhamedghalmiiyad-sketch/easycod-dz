...
export default defineConfig({
  ...
  build: {
    ...
    // Add target configuration to support modern JavaScript features
    target: 'es2022',
  },
  // Configure esbuild to support import assertions
  esbuild: {
    target: 'es2022',
    supported: {
  ...
  optimizeDeps: {
    ...
    // Support modern JavaScript features in dependencies
    esbuildOptions: {
      target: 'es2022',
      supported: {
        'import-assertions': true
